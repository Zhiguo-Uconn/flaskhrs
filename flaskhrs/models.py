...
class MedRecord(db.Model):
    ...
    bmi = db.Column(db.Integer, default=1)
    alcohol = db.Column(db.Integer, default=0)
    physical = db.Column(db.Integer, default=0)
    g_diabetes = db.Column(db.Integer, default=0)
    family_hist = db.Column(db.Integer, default=0)
    duration = db.Column(db.Integer, default=0)
    a1c = db.Column(db.Numeric(3, 1), default=7.0)
    glucose = db.Column(db.Numeric(3, 1), default=4.0)
    hdl = db.Column(db.Integer, default=60)
    ldl = db.Column(db.Integer, default=100)
    total = db.Column(db.Integer, default=200)
    tri = db.Column(db.Integer, default=150)
    sy = db.Column(db.Integer, default=110)
    dia = db.Column(db.Integer, default=80)
